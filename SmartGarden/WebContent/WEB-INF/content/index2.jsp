	...
	<div class="layout-admin">
		...
		<section class="layout-main">
			...
			<div class="layout-main-body">
				<iframe class="body-iframe" name="iframe0" width="100%" height="99%" src="loginseccess" frameborder="0" data-id="loginseccess" seamless></iframe>
			</div>
		</section>
		<div class="layout-footer">@2016 0.1 www.mycodes.net</div>
	</div>
	<script type="text/javascript" src="lib/jquery-1.9.0.min.js"></script>
	<script type="text/javascript" src="js/sccl2.js"></script>
